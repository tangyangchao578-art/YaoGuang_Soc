...
本架构规格书由以下微架构文档组成，形成完整的架构设计文档体系：

| 文档编号 | 文档名称 | 版本 | 负责人 | 状态 |
|----------|----------|------|--------|------|
| **01** | 架构规格书 (系统级) | V1.1 | 首席架构师 | 已批准 |
| **02** | IP 选型计划 | V1.0 | IP 工程师 | 草稿 |
| **03** | CPU 子系统微架构 | V1.0 | CPU 架构师 | 草稿 |
| **04** | NPU 子系统微架构 | V1.0 | NPU 架构师 | 草稿 |
| **05** | NoC 互联架构 | V1.0 | NoC 架构师 | 草稿 |
| **06** | 存储器子系统架构 | V1.0 | 存储架构师 | 草稿 |
| **07** | 时钟复位架构 | V1.0 | 时钟架构师 | 草稿 |
| **08** | 系统接口规格 | V1.0 | 接口架构师 | 草稿 |
| **09** | ISP 微架构 | V1.0 | ISP 架构师 | 草稿 |
| **10** | GPU 微架构 | V1.0 | GPU 架构师 | 草稿 |
| **11** | 电源管理架构 | V1.0 | Power 架构师 | 草稿 |
| **12** | 外设子系统架构 | V1.0 | 外设架构师 | 草稿 |
